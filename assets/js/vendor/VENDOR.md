...
`embla-carousel-wheel-gestures` лежит здесь, но в `VENDORS` не подключён:
карусель едет сама и не должна реагировать на прокрутку страницы. Файл оставлен
на случай, если горизонтальные жесты понадобятся снова.
